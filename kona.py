...
def tod():
    ...
    for x in titik:
        ...
        sys.stdout.flush()
        time.sleep(1)
logo = ' \x1b[0;92m FFFF U   U  CCC K  K \x1b[0m\n \x1b[0;91m F    U   U C    K K \x1b[0m || Author > SUFYAN AHMAD\x1b[0m\n \x1b[0;92m FFF  U   U C    KK\x1b[0m   || Github.com/sufyanahmad\x1b[0m\n  \x1b[0;91mF    U   U C    K K\x1b[0m  v1.91 || Fb > sufyanshabqadry\x1b[0m\n \x1b[0;92m F     UUU   CCC K  K\x1b[0m v1.91 || youtube > Technical Sufyan\x1b[0m'
...
def yayanxd():
    ...
    try:
        ...
        print '\n\n %sX%s Welcome To SuFyan World %s%s%s' % (O, N, K, Name, N)
        time.sleep(2)
        print ' %sX%s Dont Forg3t To Follow Me On Fb ( Sufyan.shabqadry ) & I M Not Responsible For Miss Use ' % (O, N)
        time.sleep(2)
